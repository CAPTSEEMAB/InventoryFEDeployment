// Dashboard page: analytics and overview of inventory with charts and quick stats
...
// Dashboard component: loads products and renders stats, charts and recent items
